var path,boy,cash,diamonds,jwellery,sword, end, invisibleGround;
...
function draw() {
  ...
  if(path.y > 800 ){
    ...
    if(cashG.isTouching(invisibleGround) || swordGroup.isTouching(invisibleGround) || diamondsG.isTouching(invisibleGround) || jwelleryG.isTouching(invisibleGround)) {
      gameState = END;
    }
